...
- [ ] T017 Add analytics event stub for click tracking `web/src/lib/navigation/analytics.ts`
...
- [ ] T027 [US1] Add analytics event on navigation clicks `web/src/lib/navigation/analytics.ts`
...
- [ ] T035 [US2] Add analytics event: language change timing `web/src/lib/navigation/analytics.ts`
...
- [ ] T044 [US3] Analytics event: collapse/expand toggles `web/src/lib/navigation/analytics.ts`
...
- [ ] T052 Performance measure: click-to-paint metric logging `web/src/lib/navigation/analytics.ts`
