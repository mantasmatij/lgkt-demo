...
- [X] T023 [US1] Implement frontend selection UI (report type dropdown) in `web/src/components/reports/ReportSelector.tsx`
- [X] T024 [P] [US1] Implement filters panel (generic) in `web/src/components/reports/FiltersPanel.tsx`
...
### Implementation
 ...
 - [X] T036 [US2] Integrate permission filtering into preview adapter pipeline in `api/src/services/reportCompanies.adapter.ts`
 - [X] T037 [US2] Integrate permission filtering into forms adapter in `api/src/services/reportForms.adapter.ts`
 - [X] T038 [P] [US2] Add Jest tests for field filtering logic in `api/src/utils/permissions/__tests__/reportPermissions.spec.ts`
 - [X] T039 [P] [US2] Add Jest tests ensuring unauthorized rows excluded in `api/src/services/__tests__/reportForms.adapter.spec.ts`
 - [X] T040 [US2] Add Cucumber scenario for permission-based export differences in `web/src/tests/features/reports/permissions.feature`
 - [X] T041 [US2] Add steps for permissions scenario in `web/src/tests/steps/reports/permissions.steps.ts`
 - [X] T042 [US2] Update UI to show consistent messaging (no extra gating) in `web/src/components/reports/ReportTable.tsx`
